...
Spheres can also be generated by refining the faces of platonic solids and then
"inflating" them. meshzoo implements a few of them. The sphere generated from the
isocahedron has the highest-quality (most equilateral) triangles.

<img src="https://nschloe.github.io/orthopy/tetra-sphere.png" width="70%"> |
<img src="https://nschloe.github.io/orthopy/octa-sphere.png" width="70%"> |
<img src="https://nschloe.github.io/orthopy/isoca-sphere.png" width="70%">
:-------------------:|:------------------:|:----------:|
